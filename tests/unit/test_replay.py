...
def test_trace_replay_renders_example_timeline():
    ...
    assert "[FIRST HERO] cast_skill skill_hex_seal -> enemy_hungry_cultist" in text
    ...
    assert "cast_skill skill_hex_seal -> enemy_hungry_cultist" in text
    assert "Judge: cast_skill skill_hex_seal" in text
