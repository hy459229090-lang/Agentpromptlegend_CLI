...
- `333 passed` or higher, matching README and QA note badges.
...
- Evidence count consistency reports `Evidence counts OK: 333 tests collected; 247 release-bound text files.`
