...
- `venv312/bin/python -m pytest` -> `363 passed`
- `venv312/bin/ouro validate-content` -> content OK
- `git diff --check` -> no whitespace errors
- `venv312/bin/python scripts/release_check.py --evidence-only` -> `Evidence counts OK: 363 tests collected; 247 release-bound text files.`
