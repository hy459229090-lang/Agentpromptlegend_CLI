...
_LABELS: dict[str, dict[str, str]] = {
    ...
    "hero_card_prompt": {"en": "Default Prompt", "zh": "默认提示词"},
    ...
    "hero_card_action_kit": {"en": "ACTION KIT BOARD", "zh": "技能行动套件"},
    "hero_card_positioning": {"en": "Pos", "zh": "定位"},
    "hero_card_use": {"en": "Use", "zh": "用途"},
    "hero_card_build_relation": {"en": "Build", "zh": "构筑关系"},
    ...
    "shop_prompt": {"en": "Select an item to buy, or 0/q/l to leave", "zh": "选择物品购买，或输入 0/q/l 离开"},
    ...
    "menu_entry_demo": {"en": "[2] Try / Demo     ouro try --seed 1 / ouro demo --seed 1", "zh": "[2] 快速试玩        ouro try --seed 1 / ouro demo --seed 1"},
    "menu_entry_quick_battle": {"en": "[3] Quick Battle   ouro play --mock --unicode", "zh": "[3] 快速战斗        ouro play --mock --unicode"},
    ...
    "setup_prompt": {"en": "Prompt Contract", "zh": "提示词契约"},
